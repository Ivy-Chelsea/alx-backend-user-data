...
class Base():
    ...
    def __init__(self, *args: list, **kwargs: dict):
        """
        Function that initializes a Base instance.
        """
    ...
    def to_json(self, for_serialization: bool = False) -> dict:
        """
        Function that converts the object a JSON dictionary.
        """
        result = {}
    ...
    def load_from_file(cls):
        """
        Function that loads all objects from file.
        """
    ...
    def save_to_file(cls):
        """
        Function that saves all objects to file.
        """
        s_class = cls.__name__
        file_path = ".db_{}.json".format(s_class)
        objs_json = {}
    ...
    def save(self):
        """
        Function that saves current object.
        """
    ...
    def count(cls) -> int:
        """
        Function that counts all objects.
        """
        s_class = cls.__name__
    ...
    def get(cls, id: str) -> TypeVar('Base'):
        """
        Function that returns one object by ID.
        """
        s_class = cls.__name__
    ...
    def search(cls, attributes: dict = {}) -> List[TypeVar('Base')]:
        """
        Function that searchs all objects with matching attributes.
        """
        s_class = cls.__name__
        def _search(obj):
            if len(attributes) == 0:
